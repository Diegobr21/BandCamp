...
public class Perfil {
	...
	//Metodo "editar", recibe un objeto de tipo usuario le asigna el nombre de cuenta, retorna la cuenta.
	//Por cambiar: Que el usuario seleccione que campo desea editar.
